...
{
	$query = $db->Execute("SELECT POSITIONID, POS_NAME, POS_DESC, POS_GROUP,  POS_PRICE, POS_ACTIVE FROM {$TBLName}article WHERE POS_ACTIVE='1' AND POS_NAME LIKE '$Pos_Name1%' AND POS_DESC LIKE '$Pos_Desc1%' AND POS_PRICE LIKE '%$Pos_Price1%' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
{
	$query = $db->Execute("SELECT POSITIONID, POS_NAME, POS_DESC, POS_GROUP,  POS_PRICE, POS_ACTIVE FROM {$TBLName}article WHERE POS_ACTIVE='2' AND POS_NAME LIKE '$Pos_Name1%' AND POS_DESC LIKE '$Pos_Desc1%' AND POS_PRICE LIKE '%$Pos_Price1%' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
{
	$query = $db->Execute("SELECT POSITIONID, POS_NAME, POS_DESC, POS_GROUP,  POS_PRICE, POS_ACTIVE FROM {$TBLName}article WHERE POS_NAME LIKE '$Pos_Name1%' AND POS_DESC LIKE '$Pos_Desc1%' AND POS_PRICE LIKE '%$Pos_Price1%' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
