...
//
$query = $db->Execute("SELECT CASHBOOKID, INVOICEID, PAYMENTID, DATE_FORMAT(CASHBOOK_DATE,'%d.%m.%Y') AS CASHBOOK_DATE, TAKINGS, EXPENDITURES, DESCRIPTION, CASH_IN_HAND, CASH_IN_HAND_STARTING_WITH FROM {$TBLName}cashbook WHERE CASHBOOKID=$cashbookID");
