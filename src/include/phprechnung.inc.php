...
// Manager
//
define ('USERGROUP_MANAGER',"2");

// Bookkeeping
//
define ('USERGROUP_BOOKKEEPING',"3");
...
function is_Admin() {
	if ((isset ( $_SESSION ['Usergroup1'] ) && $_SESSION ['Usergroup1'] == USERGROUP_ADMIN) || (isset ( $_SESSION ['Usergroup2'] ) && $_SESSION ['Usergroup2'] == USERGROUP_ADMIN)) {
		return true;
	} else {
		return false;
	}
...
function is_Manager() {	
	if ((isset ( $_SESSION ['Usergroup1'] ) && $_SESSION ['Usergroup1'] == USERGROUP_MANAGER) || (isset ( $_SESSION ['Usergroup2'] ) && $_SESSION ['Usergroup2'] == USERGROUP_MANAGER)) {
		return true;
	} else {
		return false;
	}
...
function is_Bookkeeper() {
	if ((isset ( $_SESSION ['Usergroup1'] ) && $_SESSION ['Usergroup1'] == USERGROUP_BOOKKEEPING) || (isset ( $_SESSION ['Usergroup2'] ) && $_SESSION ['Usergroup2'] == USERGROUP_BOOKKEEPING)) {
		return true;
	} else {
		return false;
	}
...
function CheckAdminGroup2() {
	...
	if (!is_Manager() && !is_Admin() && !is_Superuser()) {
		if (! empty ( $_SERVER ['QUERY_STRING'] )) {
			$_SESSION ['LastSite'] = $_SERVER ['PHP_SELF'] . '?' . $_SERVER ['QUERY_STRING'];
		} else {
			$_SESSION ['LastSite'] = $_SERVER ['PHP_SELF'];
...
function CheckAdminGroup3() {
	...
	if (!is_Bookkeeper() && !is_Manager() && !is_Admin() && !is_Superuser()) {
		if (! empty ( $_SERVER ['QUERY_STRING'] )) {
			$_SESSION ['LastSite'] = $_SERVER ['PHP_SELF'] . '?' . $_SERVER ['QUERY_STRING'];
		} else {
			$_SESSION ['LastSite'] = $_SERVER ['PHP_SELF'];
