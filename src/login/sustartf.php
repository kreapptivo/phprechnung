...
$query = $db->Execute ( "SELECT FULLNAME, USERNAME, LANGUAGE, USERGROUP1, USERGROUP2, LICENSE_ACCEPTED FROM {$TBLName}user WHERE USERNAME='" . SUPER_USER . "' AND PASSWORD='$pw_hash'" );
...
if (isset ( $_SESSION ['Username'] ) && $_SESSION ['Username'] === SUPER_USER || ! isset ( $_SESSION ['IPAddress'] ) || ! $numrows) {
	$_SESSION ['logoutid'] = "2";
