...
if (isset ( $_SESSION ['Username'] ) && $_SESSION ['Username'] === SUPER_USER || ! isset ( $_SESSION ['IPAddress'] )) {
	Logout ();
	@session_destroy ();
	@session_start ();
	$_SESSION ['logoutid'] = "3";
