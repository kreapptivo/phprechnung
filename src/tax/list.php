...
// Get Tax Information
//
$query = $db->Execute("SELECT TAXID, TAX_DESC FROM {$TBLName}tax ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT TAXID FROM {$TBLName}tax");
