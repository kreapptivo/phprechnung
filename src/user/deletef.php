...
if (! is_numeric ( $userID ) || $userID <= 0) {
	...
	$query1 = $db->Execute ( "SELECT USERID, USERNAME FROM {$TBLName}user WHERE USERNAME='" . SUPER_USER . "' AND USERID=$userID" );
