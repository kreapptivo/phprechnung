...
if (! $query)
	...
	foreach ( $query as $f ) {
		...
		// $smarty->assign("PASSWORD",$f['PASSWORD']); //NO PASSWORDS!
...
//
$lang = asort ( $language );
$smarty->assign ( "choose_language", array (
		$language 
) );
...
$smarty->assign ( "choose_group", array (
		$group 
) );
