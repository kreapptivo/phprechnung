...
else
{
	...
	$query1 = $db->Execute("SELECT DESCRIPTION FROM {$TBLName}category WHERE DESCRIPTION='$CCategory'");
	...
	{
		$query2 = "INSERT INTO {$TBLName}category (CATEGORYID, DESCRIPTION, CREATEDBY, MODIFIEDBY, USERGROUP1, USERGROUP2, CREATED, MODIFIED)";
