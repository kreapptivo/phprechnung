...
//
$query = $db->Execute("SELECT POSGROUPID, DESCRIPTION FROM {$TBLName}posgroup ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT POSGROUPID FROM {$TBLName}posgroup");
